...
<head>
    ...
    <title>کربن تجهیز - اضافه کردن دسته بندی</title>
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="py-3 mb-4">
                            دسته بندی
                            <span class="text-muted fw-light">/ ساخت دسته بندی</span>
                        </h4>
                        <div class="row fv-plugins-icon-container">
                            <div class="col-md-12">
                                <div class="card mb-4">
                                    <h5 class="card-header">ساخت دسته بندی</h5>
                                    <hr class="my-0">
                                    <div class="card-body">
                                        @if (session('errors'))
                                        ...
                                        @endif
                                        <form id="formAccountSettings" method="POST" action="{{url("panel/Category/Add")}}"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="mb-3 col-md-6 fv-plugins-icon-container">
                                                    <label for="firstName" class="form-label">توضیحات دسته بندی</label>
                                                    <input class="form-control" type="text" id="firstName"
                                                        name="description"
                                                        autofocus="">
                                                    <div
                                                ...
                                                <div class="mb-3 col-md-6 fv-plugins-icon-container">
                                                    <label for="firstName" class="form-label">حداقل دما</label>
                                                    <input class="form-control" type="text" id="firstName"
                                                        name="min_temp"
                                                        autofocus="">
                                                    <div
                                                ...
                                                <div class="mb-3 col-md-6 fv-plugins-icon-container">
                                                    <label for="firstName" class="form-label">حداکثر دما</label>
                                                    <input class="form-control" type="text" id="firstName"
                                                        name="max_temp"
                                                        autofocus="">
                                                    <div
