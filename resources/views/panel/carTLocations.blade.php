            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="py-3 mb-4">
                            <span class="text-muted fw-light">مدیریت /</span> نقشه
                        </h4>
                        <div class="row">
                            <div class="col-12">
                                <div class="card mb-4">
                                ...
                                <script>
                                    document.addEventListener("DOMContentLoaded", function() {
                                        ...
                                        fetch('{{ url('panel/CarT/AllDeviceLocationApi') }}')
                                                ...
                                                if (data.message === 'succeess') {
                                                    ...
                                                    devices.forEach(device => {
                                                        ...
                                                        L.circleMarker([device.latitude, device.longitude], {
                                                            ...
                                                            .bindPopup('راننده: ' + device.drtiver + '<br>دسته بندی: ' + device
                                                                .category + '<br>شماره سریال: ' + '<a href="' + device.url +'">' + device.serial + '</a>' +
                                                                '<br>نام دستگاه: ' + device.name)
