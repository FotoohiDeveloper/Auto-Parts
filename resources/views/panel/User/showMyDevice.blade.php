...
<head>
    ...
    <title>کربن تجهیز - لیست دستگاه ها</title>
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    <div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        <h4 class="py-3 mb-4">
                            <span class="text-muted fw-light">دستگاه ها/</span> لیست دستگاه ها
                        </h4>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if ($device->last_activity == null)
                                                        آخرین فعالیت ندارد
                                                    @else
                                                        {{ convertDate($device->last_activity) }}
                                                    @endif
                                                </td>
                                                <td>
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            @if ($device->model_id == 0 or $device->model_id == 3 or $device->model_id == 4)
                                                                <a class="dropdown-item"
                                                                    href="{{ url("panel/Device/My/$device->serial_number/Location") }}"><i
                                                                        class="ti ti-pencil me-1"></i>مشاهده اطلاعات
                                                                    موقعیت</a>
                                                            @endif
                                                            <a class="dropdown-item"
                                                                    href="{{ url("panel/Device/My/$device->serial_number/Owners") }}"><i
                                                                        class="ti ti-users me-1"></i>مالکان دستگاه</a>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
