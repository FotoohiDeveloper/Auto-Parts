...
<head>
    ...
    <title>کربن تجهیز - گزارش دستی</title>
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="py-3 mb-4">
                            گزارش گیری
                            <span class="text-muted fw-light">/ گزارش دستی</span>
                        </h4>
                                ...
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form id="formAccountSettings" method="POST"
                                            action="{{ url('panel/ManualReport') }}"
                                            class="fv-plugins-bootstrap5 fv-plugins-framework" novalidate="novalidate">
                                            @csrf
                                            <div class="row">
                                                <div class="mb-3 col-md-6 fv-plugins-icon-container">
                                                    <label for="firstName" class="form-label">از تاریخ</label>
                                                    <input class="form-control" type="text" id="firstName"
                                                        name="from" autofocus="" data-jdp required>
                                                    <div
                                                        class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback">
                                                    </div>
                                                </div>
                                                <div class="mb-3 col-md-6 fv-plugins-icon-container">
                                                    <label for="firstName" class="form-label">تا تاریخ</label>
                                                    <input class="form-control" type="text" id="firstName"
                                                        name="to" autofocus="" data-jdp required>
                                                    <div
                                                        class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback">
                                                    </div>
                                                </div>
                                            ...
                                            <div class="mt-2">
                                                <button type="submit"
                                                    class="btn btn-primary me-2 waves-effect waves-light">دانلود
                                                    گزارش</button>
                                            </div>
                                        </form>
                                    </div>
